...
/*
  ------------- 
  Zad. 2 Dodac tutaj define o wartosci grup A i B
*/

#define GROUP_A 1
#define GROUP_B 2
#define GROUP_DELETED 3

#define GROUP_A_SCHED_TICKS_COUNT 5
#define GROUP_B_SCHED_TICKS_COUNT 10
